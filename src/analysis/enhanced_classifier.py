...
def main():
    ...
    # Load subdomains with proper encoding handling
    encodings_to_try = ['utf-8', 'latin-1', 'cp1252', 'iso-8859-1']
    subdomains = []
    
    for encoding in encodings_to_try:
        try:
            with open(args.file, 'r', encoding=encoding, errors='ignore') as f:
    ...
    if not subdomains:
        print(f"[-] Could not read file with any encoding: {args.file}")
        return
